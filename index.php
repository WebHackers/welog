	...
	<div data-role="page" id="home" class="ui-responsive-panel" style="font-family:FirstFont">
            ...
            <h2><span class="center" style="font-family:jya">产品组</span></h2>
				...
				?>
					...
					<div data-role="collapsible" id="productteam" data-collapsed-icon="false">
                        ...
                        <p style="text-align:left; text-indent:2em; font-family:jya;"><?php echo $infop['team_info']?></p>
            ...
            <div data-role="collapsible" id="create" data-collasped-icon="false" >
				...
				?>
					...
					<div data-role="collapsible" id="productteam" data-collapsed-icon="false">
                        ...
                        <p style="text-align:left; text-indent:2em; font-family:jya"><?php echo $infoc['team_info']?></p>
        ...
        <div data-role="panel" id="paneltwo" data-position="right" data-display="overlay">
            <div data-role="header" data-theme="c">
            	<h2><span style="font-family:jya">Rank</span></h2>
            </div>
            <div data-role="content" align="center">
            	<ul data-role="listview">
                	<div data-role="collapsible" data-theme="e" data-collapsed-icon="false">
                    <h2><span style="font-family:jya">Top 10 Groups</span></h2>
                    <?php
                    ...
                    ?>
                    	<li><a data-role="button" style="font-family:jya"><?php echo $info5['team_name'];?><span class="ui-li-count"><?php echo $info5['team_poll'];?></span></a></li>
                    <?php
                    ...
                    <div data-role="collapsible" data-collapsed-icon="false">
                   	<h2 ><span style="font-family:jya">Product Groups</span></h2>
                    <?php
						while($info=mysqli_fetch_array($res2)){ 
					?>
                		<li><a data-role="button" style="font-family:jya"><?php echo $info['team_name'];?><span class="ui-li-count"><?php echo $info['team_poll'];?></span></a></li>
                    <?php
						}
					?>
                    </div>
                    <div data-role="collapsible" data-theme="e" data-collapsed-icon="false">
                    <h2><span style="font-family:jya">Creative Groups</span></h2>
                    <?php
						while($info1=mysqli_fetch_array($res3)){
                    ?>
                    	<li><a data-role="button" style="font-family:jya"><?php echo $info1['team_name'];?><span class="ui-li-count"><?php echo $info1['team_poll'];?></span></a></li>
                    <?php
						}
					?>
                    </div>
